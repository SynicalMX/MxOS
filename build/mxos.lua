...
OS.__name__ = true
OS.boot = function()
  __haxe_Log.trace("Hello, wordl!", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/OS.hx",lineNumber=6,className="OS",methodName="boot"}));
end
